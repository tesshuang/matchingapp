...
import MResultDis from './MResultDisforMamp';
...
class MControl extends Component {
    ...
    fetchWords(){
        ...
        fetch("http://localhost:8888/beavver.taliawalkey.ca/array.php",{
            method:"POST",
            body:fd
        }).then((resp)=>{
            return resp.json();
...
/*        this.refs.hello.scrollIntoView({behavior: "smooth", block: "end", inline: "nearest"});*/
    ...
    fetchCourse(missing){
        ...
        fetch("http://localhost:8888/beavver.taliawalkey.ca/courses.php",{
            method:"POST",
            body:fd
        }).then((resp)=>{
            return resp.json();
